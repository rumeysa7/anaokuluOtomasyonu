...
public class Ogrenci
{
    ...
    public Ogrenci(Integer ogrenci_No, String ogrenci_Ad, String ogrenci_Soyad, Integer ogrenci_Tc_No, String ogrenci_Veli1, String ogrenci_Veli2, String ogrenci_Boy, String ogrenci_Kilo, String ogrenci_Dogum_Tarih, String ogrenci_Sinif, String o_Ad, String ogrenci_Ilac) {
    ...
    public Integer getOgrenci_Tc_No() {
        return ogrenci_Tc_No;
    }

    public void setOgrenci_Tc_No(Integer ogrenci_Tc_No) {
        this.ogrenci_Tc_No = ogrenci_Tc_No;
    }
    ...
    public void setOgrenci_Dogum_Tarih(String ogrenci_Dogum_Tarih) {
        this.ogrenci_Dogum_Tarih = ogrenci_Dogum_Tarih;
    }
