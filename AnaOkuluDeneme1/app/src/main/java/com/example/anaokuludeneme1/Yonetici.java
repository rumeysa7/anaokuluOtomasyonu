...
public class Yonetici
{
    ...
    private Integer y_Tc_No;

    public Yonetici(){
    }

    public Yonetici(String y_Ad, String y_Soyad, String y_Tel, String y_Mail, String y_Sifre, String gorev, Integer y_Tc_No) {
        this.y_Ad = y_Ad;
    ...
    public Integer getY_Tc_No() { return y_Tc_No; }

    public void setY_Tc_No(Integer y_Tc_No) { this.y_Tc_No = y_Tc_No; }
}
