...
public class Veli
{
    ...
    public Veli(String v_Ad, String v_Soyad, String v_Tel, String v_Mail, String v_Sifre, String v_Adres, String ogrenci_Ad, String ogrenci_Soyad
            , Integer ogrenci_Numara, Integer v_Tc_No) {
        this.v_Ad = v_Ad;
    ...
    public Integer getv_Tc_No() { return v_Tc_No; }

    public void setv_Tc_No(Integer v_Tc_No) { this.v_Tc_No = v_Tc_No; }
}