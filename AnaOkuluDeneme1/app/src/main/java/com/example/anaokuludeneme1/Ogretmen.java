...
public class Ogretmen
{
    ...
    private Integer o_Tc_No;

    public Ogretmen(){
    }

    public Ogretmen(String o_Ad, String o_Soyad, String o_Tel, String o_Mail, String o_Sifre, String sinif, Integer o_Tc_No) {
        this.o_Ad = o_Ad;
    ...
    public Integer getO_Tc_No() { return o_Tc_No; }

    public void setO_Tc_No(Integer o_Tc_No) { this.o_Tc_No = o_Tc_No; }
}
