...
public class Etkinlik_Ekle_Activity extends AppCompatActivity {
    ...
    private Button btnEtkinlikEkle, btnEtkinlikDuzenle;
    ...
    public void init() {
        ...
        btnEtkinlikDuzenle = (Button) findViewById(R.id.btnUpdateEvent);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEtkinlikDuzenle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent etkinlik_duzenle= new Intent(Etkinlik_Ekle_Activity.this, Etkinlik_Duzenle_Activity.class);
